...
```mermaid
flowchart LR
    source["/mnt/ssd4t/protein-design/data/src/alphafold3<br/>official AlphaFold 3 v3.0.2 source"]
    wheel["/mnt/ssd4t/protein-design/data/src/alphafold3/wheelhouse<br/>local nvidia-cublas-cu12 wheel"]
    image["pd-af3-gpu:v3.0.2"]
    models["/mnt/ssd4t/protein-design/data/alphafold3/models<br/>af3.bin.zst"]
    db["/mnt/ssd4t/protein-design/data/alphafold3/public_databases"]
    cache["/mnt/ssd4t/protein-design/data/alphafold3/jax_cache"]
...
`/mnt/ssd4t/protein-design/data/src/alphafold3`; it does not use
`pd-af2multimer-gpu`, the AlphaFold 2 Multimer Dockerfile, or
`data/alphafold_db`.

本项目中 AlphaFold 3 与 AlphaFold 2 Multimer 相互独立。`pd-af3-gpu:v3.0.2`
镜像来自 `/mnt/ssd4t/protein-design/data/src/alphafold3` 下的官方 AlphaFold 3 源码，
不使用 `pd-af2multimer-gpu`、AlphaFold 2 Multimer Dockerfile 或
`data/alphafold_db`。
